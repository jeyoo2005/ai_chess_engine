"""
Chessboard logic for managing moves, piece placement, and special rules (like castling and promotion).
"""
    ...
    def draw(self, screen):
        ...
        for row in range(8):
            for col in range(8):
                ...
                if piece:
                    piece = Board.images.get(f"{piece.color}_{piece.name}")
                    if piece:
                        screen.blit(piece, (col * 100, row * 100))
